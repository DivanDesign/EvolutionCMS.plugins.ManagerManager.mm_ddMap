...
function mm_ddYMap($tvs, $roles = '', $templates = '', $w = 'auto', $h = '400', $hideField = true){
	...
	if ($e->name == 'OnDocFormPrerender'){
		...
		$output = includeJs($modx->config['site_url'].'assets/plugins/managermanager/widgets/ddymap/jquery.ddMM.mm_ddYMap-1.0.1.js', 'html', 'jquery.ddMM.mm_ddYMap', '1.0.1');
		//The Yandex.Maps library including
		$output .= includeJs('http://api-maps.yandex.ru/2.0/?load=package.full&lang=ru-RU&onload=mm_ddYMap_init', 'html', 'api-maps.yandex.ru', '2.0');
